...
namespace SwaggerDogSittersTests.Client
{
    public class NewClientsClient
    {
        ...
        public List<SitterResponseModel> GetSearch(SearchRequestModel model)
        { 
            HttpStatusCode expectedCode = HttpStatusCode.OK;
            ...
            List<SitterResponseModel> sitters = JsonSerializer.Deserialize<List<SitterResponseModel>>(responseJson)!;
            return sitters;
        }
